-- ============================================================================
-- Customer Loyalty: Modify create_sale to award points
-- ----------------------------------------------------------------------------
-- After a completed sale, if the tenant has loyalty_enabled=true,
-- award 1 point per 1000 UGX of the sale total.
-- ============================================================================

-- Re-declare create_sale with loyalty points awarding logic
